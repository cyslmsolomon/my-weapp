...
Page({
  data: {
    ...
    currentNavbar: '0',
    swipers: [
      '/images/drawable-xhdpi/banking_banner_zh.png',
      '/images/drawable-xhdpi/image_banner1.jpg',
      '/images/drawable-xhdpi/image_banner2.jpg',
      '/images/drawable-xhdpi/image_banner3.jpg'
    ],
    list: [],
    hot_last_id: 0,
    latest_list: [],
